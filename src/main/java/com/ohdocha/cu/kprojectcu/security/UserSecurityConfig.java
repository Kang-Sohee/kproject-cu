...
public class UserSecurityConfig  {
    ...
    public static class UserConfiguration extends WebSecurityConfigurerAdapter {
    	...
    	@Autowired
    	public com.ohdocha.cu.kprojectcu.security.DochaLoginSuccessHandler dochaLoginSuccessHandler;
        ...
        protected void configure(HttpSecurity http) throws Exception {
    		...
    		http.authorizeRequests()
    				...
    				.antMatchers("/login.do").permitAll()
    				.antMatchers("/user/logins.do").permitAll()
    	...
    	@Bean
    	public com.ohdocha.cu.kprojectcu.security.DochaLogoutSuccessHandler dochaLogoutSuccessHandler() {
    		
    		return new com.ohdocha.cu.kprojectcu.security.DochaLogoutSuccessHandler();
    	}
